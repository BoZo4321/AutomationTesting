# Vikta UI Testing Sample

- The app intentionally contains many embedded bugs.
- You are expected to identify these bugs and create defect reports (consult your mentor if needed).
- Run the tests to determine what works and what doesn't; tests should fail if Vikta has a bug.
- You may need to connect to the database to investigate issues—**this is one of the additional tasks.**
- Good luck!
